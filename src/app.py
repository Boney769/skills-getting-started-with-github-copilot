...
activities = {
    ...
    "Basketball Team": {
        "description": "Team-based basketball practice and competitive league play",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["kevin@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim workouts and swim meet preparation",
    ...
    "Music Ensemble": {
        "description": "Rehearse and perform music in a small ensemble",
